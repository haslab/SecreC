...
template<type T>
PrecisionTest<T> test_addition(T data){
...
void main() {
    string test_prefix = "Float32/64 Addition precision";
    {
        PrecisionTest<float32> rv = test_addition(0::float32);
        test(test_prefix, rv);
    }
    {
        PrecisionTest<float64> rv = test_addition(0::float64);
        test(test_prefix, rv);
    }
